...
// - We also decided to add 'jre' due to `com.google.guava:guava`
const TRIMMED_QUALIFIERS = [
  'ga', 'final', 'release', 'jre',
];
...
class MavenSemver {
  ...
  getNormalizedQualifiers() {
    ...
    if (!isNaN(version) &&
      ...
      ALIASES.hasOwnProperty(qualifier.toLowerCase())) {
      ...
      if (typeof firstLetters === 'string' &&
        ALIASES.hasOwnProperty(firstLetters.toLowerCase())) {
