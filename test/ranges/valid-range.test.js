...
test('validRange(range)', t => {
  ...
  t.is(validRange('[3.9,3.9.1.Final]'), '[3.9,3.9.1.Final]');
  t.is(validRange('[1.0.10.GA_CP03,)'), '[1.0.10.GA_CP03,)');
  t.is(validRange('[1.0.10.GA], [1.0.10.GA_CP01], [1.0.10.GA_CP02]'),
    '[1.0.10.GA],[1.0.10.GA_CP01],[1.0.10.GA_CP02]');
  t.is(validRange('[4,4.3.2.Final]'), '[4,4.3.2.Final]');
  t.is(validRange('[4.3.3.Final,5)'), '[4.3.3.Final,5)');
  t.is(validRange('(,1.0.4]'), '(,1.0.4]');
  t.is(validRange('[1.0.5,)'), '[1.0.5,)');
  t.is(validRange('[1.0.1.Final], (,1.0-final]'),
    '[1.0.1.Final],(,1.0-final]');
  t.is(validRange('[1.1.0-Alpha1,)'), '[1.1.0-Alpha1,)');
  t.is(validRange('[7,7.2.1], [3,3.0.0-CR2]'), '[7,7.2.1],[3,3.0.0-CR2]');
  t.is(validRange('[7.2.0.Final-redhat-2], [7.2.2,8)'),
    '[7.2.0.Final-redhat-2],[7.2.2,8)');
